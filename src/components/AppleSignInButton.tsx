...
export default function AppleSignInButton({
  ...
  return (
    <form action={signInWithApple}>
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-black px-3 py-2.5 text-sm font-semibold text-white transition hover:bg-black/90 focus:outline-none focus:ring-2 focus:ring-night/40"
      >
