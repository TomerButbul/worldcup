// Fill Claude's (Maple's) WC2026 bracket. Resolves every knockout match from the
// group order + the canonical FIFA template, ASSERTS each picked winner is a real
// participant (so a typo can't slip through), prints the bracket, then upserts
// bracket_predictions for Maple in the global league via the service role.
...
const MAPLE = "9d271793-3de2-41e7-adfc-e8aa51a46399";
...
const ORDER_N = {
  A:["Mexico","SouthKorea","Czech","SouthAfrica"], B:["Switzerland","Canada","Qatar","Bosnia"],
  ...
  K:["Portugal","Colombia","CongoDR","Uzbekistan"], L:["England","Croatia","Panama","Ghana"],
};
const group_order = Object.fromEntries(Object.entries(ORDER_N).map(([g, a]) => [g, a.map((n) => ID[n])]));
const third_qualifiers = ["A","D","E","F","G","I","J","L"];
...
const PICK_N = {
  73:"SouthKorea",74:"Germany",75:"Morocco",76:"Brazil",77:"France",78:"Senegal",
  79:"Mexico",80:"England",81:"USA",82:"Belgium",83:"Colombia",84:"Spain",
  85:"Switzerland",86:"Argentina",87:"Portugal",88:"Egypt",
  89:"France",90:"Morocco",91:"Brazil",92:"England",93:"Spain",94:"Belgium",
  95:"Argentina",96:"Portugal",97:"France",98:"Spain",99:"England",100:"Argentina",
  101:"Spain",102:"England",104:"Spain",103:"France",
};
...
const { error } = await sb.from("bracket_predictions").upsert(
  { league_id: GLOBAL, user_id: MAPLE, group_order, third_qualifiers, knockout, champion_team_id: ID.Spain, submitted_at: now, updated_at: now },
