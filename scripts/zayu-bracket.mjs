// Fill ChatGPT's (Zayu's) WC2026 bracket. Same validated engine as Maple's: the
// round-by-round answers are reconciled onto the fixed FIFA pairings (where
// ChatGPT named two teams that actually meet earlier, the deeper pick advances),
// every winner asserted to be a real participant, then upserted with awards.
...
const ZAYU = "b17bb09d-8713-4e8c-b1b2-9b33a5ed7aba";
...
const ORDER_N = {
  A:["Mexico","SouthKorea","Czech","SouthAfrica"], B:["Switzerland","Canada","Bosnia","Qatar"],
  C:["Brazil","Morocco","Scotland","Haiti"], D:["USA","Turkiye","Paraguay","Australia"],
...
const third_qualifiers = ["C","D","E","F","H","I","J","L"];
...
const PICK_N = {
  73:"SouthKorea",74:"Germany",75:"Netherlands",76:"Brazil",77:"France",78:"Senegal",
  ...
  101:"France",102:"Brazil",104:"Brazil",103:"Argentina",
};
...
const awards = { golden_boot: 278, golden_ball: 762, golden_glove: 22221, young_player: 396623 };
const sb = createClient(env.NEXT_PUBLIC_SUPABASE_URL, env.SUPABASE_SERVICE_ROLE_KEY, { auth: { persistSession: false } });
const now = new Date().toISOString();
const { error } = await sb.from("bracket_predictions").upsert(
  { league_id: GLOBAL, user_id: ZAYU, group_order, third_qualifiers, knockout, champion_team_id: ID.Brazil, awards, submitted_at: now, updated_at: now },
